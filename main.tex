...
\renewcommand{\maketitle}{%
  \begin{titlepage}%
    ...
    \begin{center}%
      ...
      {\small\textcolor{black!50}{v1.0.0\quad---\quad February 18, 2026}}
    \end{center}\par
    \@thanks
    \vfil\null
  \end{titlepage}%
