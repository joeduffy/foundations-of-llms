...
\renewcommand{\maketitle}{%
  \begin{titlepage}%
    ...
    \vskip 40\p@
    \begin{center}%
      % A restrained line diagram in the book's one interior accent color,
      % not an illustration in its own right -- clean strokes rather than
      % the gilt aura of the previous cover, so the page reads as typeset
      ...
      {\fontsize{20}{24}\selectfont\bfseries\textls[80]{\MakeUppercase{The Foundations of}}}\\[10pt]
      {\fontsize{24}{28}\selectfont\bfseries\textls[80]{\MakeUppercase{Large Language Models}}}\\[18pt]
      \rule{2.4cm}{0.6pt}\\[16pt]
      {\large 1943 -- 2026}\\[8pt]
      {\color{inkblue}\small\textsc{Second Edition}}\\[42pt]
