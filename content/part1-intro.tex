...
This period introduced four core concepts: artificial neurons, perceptron learning algorithms, associative memory networks, and backpropagation. These developments emerged within early computing research and cybernetics, establishing mathematical tools for machine learning systems.
...
\item \textbf{Elman (1990)} -- Introduced simple recurrent networks, demonstrating that temporal structure in sequences could be captured through recurrent connections.
\end{enumerate}
