...
InstructGPT adapted RLHF to language models, using human preferences to align GPT-3's behavior. Constitutional AI extended the approach with AI-generated feedback. RLAIF replaced human labelers with AI judges for scalability. DPO simplified the pipeline by directly optimizing preferences without explicit reward modeling. Self-rewarding language models enable models to generate their own preference data. Every major LLM alignment approach descends from this work's core insight about learning from preferences.
