...
\textbf{Efficient Attention (2020):} Performers and related work explored linear-complexity attention mechanisms to address computational constraints as sequences grew longer.
...
\item \textbf{Choromanski et al. (2020)} -- Performers introduced efficient attention mechanisms with linear computational complexity.
