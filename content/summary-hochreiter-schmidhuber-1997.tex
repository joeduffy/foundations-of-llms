...
LSTM introduced a novel architecture with memory cells guarded by multiplicative input and output gates, allowing networks to selectively store and access information over long sequences. The gates control information flow through multiplicative interactions, preventing gradient vanishing during backpropagation through time. This architecture enables networks to learn dependencies in excess of 1000 time steps, a capability impossible for standard RNNs. The constant error carousel mechanism maintains gradient flow across many timesteps without exponential decay or explosion. The forget gate, now universally treated as part of LSTM, was added two years later by Gers, Schmidhuber, and Cummins (1999).
