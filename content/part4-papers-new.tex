...
\clearpage
\phantomsection
\label{paper:espeholt-2018-impala}
\addcontentsline{toc}{subsection}{[2018] IMPALA: Scalable Distributed Deep-RL (Espeholt et al.)}
\includepdf[pages=-,pagecommand={\thispagestyle{empty}}]{pdfs/espeholt-2018-impala.pdf}
