...
% Era labels (left side)
\node[era] at (-6.5, 0) {Part I};
\node[era] at (-6.5, -2.5) {Part II};
\node[era] at (-6.5, -5) {Part III};
\node[era] at (-6.5, -7.5) {Part IV};
\node[era] at (-6.5, -10) {Part V};
\node[era] at (-6.5, -12.5) {Part VI};
\node[era] at (-6.5, -15) {Part VII};

% Year labels
\node[font=\tiny, text=black!50] at (-5.8, 0) {1943--1990};
\node[font=\tiny, text=black!50] at (-5.8, -2.5) {1990--2013};
\node[font=\tiny, text=black!50] at (-5.8, -5) {2012--2015};
\node[font=\tiny, text=black!50] at (-5.8, -7.5) {2017--2019};
\node[font=\tiny, text=black!50] at (-5.8, -10) {2019--2020};
\node[font=\tiny, text=black!50] at (-5.8, -12.5) {2021--2022};
\node[font=\tiny, text=black!50] at (-5.8, -15) {2023--2024};
