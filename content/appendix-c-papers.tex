...
\clearpage
\phantomsection
\label{paper:openai-2025-gpt5}
\addcontentsline{toc}{subsection}{[2025] GPT-5 System Card (OpenAI)}
\includepdf[pages=-,pagecommand={\thispagestyle{empty}}]{pdfs/openai-2025-gpt5.pdf}
