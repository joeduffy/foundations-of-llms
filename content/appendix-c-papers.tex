...
% 2025: o3 Competitive Programming
\clearpage
\phantomsection
\label{paper:openai-2025-o3}
\addcontentsline{toc}{subsection}{[2025] Competitive Programming with Large Reasoning Models (OpenAI)}
\includepdf[pages=-,pagecommand={\thispagestyle{empty}}]{pdfs/openai-2025-o3-competitive-programming.pdf}
