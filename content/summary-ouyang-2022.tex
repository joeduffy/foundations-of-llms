...
ChatGPT applied InstructGPT's approach at scale, catalyzing widespread LLM adoption. GPT-4, Claude, Gemini, and all major LLM chatbots use RLHF or variants. \hyperref[paper:bai-2022]{Constitutional AI (Bai et al., 2022)}, RLAIF, and \hyperref[paper:rafailov-2023-dpo]{DPO (Rafailov et al., 2023)} refined the alignment process. The instruction-following paradigm established by InstructGPT became universal for LLM interaction. Modern alignment research builds directly on this foundation.
