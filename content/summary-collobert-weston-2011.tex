...
Word2Vec (\hyperref[paper:mikolov-2013]{Mikolov et al., 2013}) dramatically simplified and scaled the word embedding approach. GloVe (\hyperref[paper:pennington-2014]{Pennington et al., 2014}) combined count-based and predictive methods. ELMo (\hyperref[paper:peters-2018]{Peters et al., 2018}) extended to contextualized embeddings. BERT (\hyperref[paper:devlin-2018]{Devlin et al., 2018}) achieved state-of-the-art across NLP tasks with pretrained Transformers. Collobert and Weston's earlier ICML 2008 paper, of which this work is the extended treatment, received the ICML Test of Time Award in 2018.
