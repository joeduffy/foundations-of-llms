...
\renewcommand{\maketitle}{%
  \begin{titlepage}%
    ...
    \begin{center}%
      ...
      {\large Compiled for the Scientific Community}\\[12pt]
      \vskip 1.5em%
      {\footnotesize\textcolor{black!60}{Created by Joe Duffy \texttt{<joeduffy@acm.org>}}}\\[6pt]
    \end{center}\par
    \@thanks
    \vfil\null
  \end{titlepage}%
