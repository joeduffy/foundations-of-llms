...
\hypersetup{
    pdftitle={The Foundations of Large Language Models, 1906-2025 (Mobile Edition)},
...
\renewcommand{\maketitle}{%
  \begin{titlepage}%
    ...
    \begin{center}%
      ...
      {\fontsize{16}{20}\selectfont\bfseries 1906 -- 2025}\\[36pt]
...
\part{Probabilistic \& Mathematical Foundations\\1906--1943}
\input{content/part0-chapter}

% Part I: Neural Beginnings & RL Foundations (1943–1990)
\part{Neural Beginnings \& RL Foundations\\1943--1990}
...
\part{Deep Learning, Attention \& Deep RL\\2012--2016}
\input{content/part3-chapter-new}

% Part IV: Transformers, RLHF & Pretraining (2017–2019)
\part{Transformers, RLHF \& Pretraining\\2017--2019}
...
\part{Open Models \& Advanced Alignment\\2023--2024}
\input{content/part7-chapter-new}

% Appendices
\appendix

% Appendix A: Emerging Results (2024–2025)
\chapter{Emerging Results (2024--2025)}
