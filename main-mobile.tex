...
% Mobile-friendly page geometry with minimal margins
\geometry{
    paperwidth=7in,
    paperheight=10in,
    inner=0.5in,
...
\hypersetup{
    pdftitle={The Foundations of Large Language Models, 1943-2025 (Mobile Edition)},
...
\renewcommand{\maketitle}{%
  \begin{titlepage}%
    ...
    \begin{center}%
      ...
      \vfill
      {\large Mobile Edition -- Optimized for Tablet Reading}\\[12pt]
...
\part{The Deep Learning Revolution\\2012--2016}
\input{content/part3-deeplearning-chapter}

% Part IV: Attention and Sequence-to-Sequence Modeling (2014–2016)
\part{Attention and Sequence-to-Sequence Modeling\\2014--2016}
\input{content/part4-chapter}

% Part V: The Transformer Era and Pretraining Revolution (2017–2019)
\part{The Transformer Era and Pretraining Revolution\\2017--2019}
\input{content/part5-chapter}

% Part VI: Emergence and Scale (2019–2020)
\part{Emergence and Scale\\2019--2020}
\input{content/part6-chapter}

% Part VII: Efficiency, Alignment, and Reasoning (2021–2022)
\part{Efficiency, Alignment, and Reasoning\\2021--2022}
\input{content/part7-chapter}

% Part VIII: Open LLMs and Modern Frontier (2023–2024)
